...
Sphereical distance between pair of stations can be calculated via `rnoaa::meteo_spherical_distance()`. We write a small wrapper function here to find the 5 closest stations in each city:
