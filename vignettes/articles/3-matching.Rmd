...
nsw_map <- ozmaps::abs_ste |> 
  ...
  rmapshaper::ms_simplify(keep = 1e-2)
...
ggplot2::ggplot() +
  ggplot2::geom_sf(data = nsw_map, color = "grey", linetype = "dotted") +
  ggplot2::geom_point(data = nsw, ggplot2::aes(x = long, y = lat, color = automated)) +
  ggplot2::theme_bw() +
